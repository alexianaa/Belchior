        ...
        <div id="conteudo" class="mt-5 mb-5">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div>
                        <h1 class="nome-loja">Bsb.brechó</h1>
                    </div>
                    <!-- Foto principal da loja -->
                    <div class="col-sm-6">
                        <img src="../img/bsb.brecho/bsb.brecho.jpeg" class="img-fluid tam" style="min-width: 200px;">
                    </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <ul>
                            <li><h5>Instagram: <a class="nav-link active" href="https://www.instagram.com/bsb.brecho" style="color: #E56399;">@bsb.brecho</a></h5></li>
                        </ul>
            ...
            <div class="container">
                <div class="row align-items-evenly mt-5">
                    ...
                    <div class="col-sm-5 me-5">
                        ...
                        <div class="row">
                            <?php $medias = "SELECT AVG(qtd_estrela) FROM avaliacoes WHERE id = 6";
                ...
                <div id="carouselPagLoja" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="../img/bsb.brecho/Sem título.jpg" class="d-inline-block img-paginaloja" alt="...">
                        <img src="../img/bsb.brecho/3.jpg" class="d-none d-md-inline-block img-paginaloja" alt="...">
                        <img src="../img/bsb.brecho/2.jpg" class="d-none d-md-inline-block img-paginaloja" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="../img/bsb.brecho/4.jpg" class="d-inline-block img-paginaloja" alt="...">
                        <img src="../img/bsb.brecho/5.jpg" class="d-none d-lg-inline-block img-paginaloja" alt="...">
                        <img src="../img/bsb.brecho/6.jpg" class="d-none d-lg-inline-block img-paginaloja" alt="...">
                      </div>
                    </div>
