        ...
        <div id="conteudo" class="mt-5 mb-5">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div>
                        <h1 class="nome-loja">Brechoanatê</h1>
                    </div>

                    <!-- Foto principal da loja -->
                    <div class="col-sm-6">
                        <img src="../img/Brechoanate/brechoanate1.jpeg" class="img-fluid tam" style="min-width: 200px;">
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <ul>
                            <li><h5>Instagram: <a class="nav-link active" href="https://www.instagram.com/brechoanate" style="color: #E56399;">@brechoanate</a></h5></li>
                        </ul>
                ...
                <div id="carouselPagLoja" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="../img/Brechoanate/brechoanate2.png" class="d-inline-block img-paginaloja" alt="...">
                        <img src="../img/Brechoanate/brechoanate3.png" class="d-none d-md-inline-block img-paginaloja" alt="...">
                        <img src="../img/Brechoanate/brechoanate4.png" class="d-none d-md-inline-block img-paginaloja" alt="...">
                      </div>
                      <div class="carousel-item">
                        <img src="../img/Brechoanate/brechoanate5.png" class="d-inline-block img-paginaloja" alt="...">
                        <img src="../img/Brechoanate/brechoanate6.png" class="d-none d-lg-inline-block img-paginaloja" alt="...">
                        <img src="../img/Brechoanate/brechoanate7.png" class="d-none d-lg-inline-block img-paginaloja" alt="...">
                      </div>
                    </div>
