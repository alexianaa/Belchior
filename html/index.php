...
<body>
    ...
    <div id="conteudo" class="pt-5 pb-5">
                    ...
                    <div id="divBusca" style="text-align: end;" class="pt-3">
                        <form action="busca2.php" method="post">
                            <input type="text" name="nome_brecho" size="23" placeholder="Encontre o brechó ideal"
                                aria-label="buscar" style="height: 30px; padding-left: 2%; border: 2px solid black;"
                                required>
                            <input type="submit" value="Buscar" name="submit"
                                style="border: 2px solid black; background-color: #DE6E4B; height: 30px; width: 70px;"></input>
                        </form>
                    </div>
        ...
        <div id="carouselPagLoja" class="carousel carousel-dark slide pt-5" data-bs-ride="carousel">
            ...
            <div class="carousel-indicators">
                <button type="button" data-bs-target="#carouselPagLoja" data-bs-slide-to="0" class="active"
                    aria-current="true" aria-label="Slide 1"></button>
                <button type="button" data-bs-target="#carouselPagLoja" data-bs-slide-to="1"
                    aria-label="Slide 2"></button>
                <button type="button" data-bs-target="#carouselPagLoja" data-bs-slide-to="2"
            ...
            <button class="carousel-control-prev d-none d-md-block" type="button" data-bs-target="#carouselPagLoja"
                data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next d-none d-md-block" type="button" data-bs-target="#carouselPagLoja"
                data-bs-slide="next">
        ...
        <div style="border: 3px solid rgba(127, 209, 185, 1); margin-left: 2%; margin-right: 2%;">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d30719.66597683526!2d-47.84938210932007!3d-15.75334788103361!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1zYnJlY2jDsw!5e0!3m2!1spt-BR!2sbr!4v1628535576889!5m2!1spt-BR!2sbr"
                width="100%" height="340px" allowfullscreen="" loading="lazy"></iframe>
        </div>
    </div>
    ...
    <div id="rodape">
        <div class="d-flex">
            ...
            <div class="me-auto">
                <h5><a class="nav-link active text-white pt-4" aria-current="page" href="termos_de_uso.html">Termos de
                        uso</a></h5>
                <!-- Copyright -->
