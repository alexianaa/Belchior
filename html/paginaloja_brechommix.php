        ...
        <div id="conteudo" class="mt-5 mb-5">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        <img src="../img/brecho_mmix/brechommix1.png" class="img-fluid tam" style="min-width: 200px;">
                    </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <ul>
                            <li><h5>Instagram: <a class="nav-link active" href="https://www.instagram.com/brechommix" style="color: #E56399;">@brechommix</a></h5></li>
                        </ul>
            ...
            <div class="container">
                <div class="row align-items-evenly mt-5">
                    ...
                    <div class="col-sm-5 me-5">
                        ...
                        <div class="row">
                            <?php $medias = "SELECT AVG(qtd_estrela) FROM avaliacoes WHERE id = 5";
